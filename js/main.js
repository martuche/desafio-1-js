...
for (let i = 1; i <= 14; i++) {
    ...
    totalGanancia = totalGanancia + parseFloat(prompt("Ingrese la ganancia del dia: " + i + " de Enero"));
}

alert("En la 1ra quincena de Enero se ganó un total de: $" + totalGanancia);